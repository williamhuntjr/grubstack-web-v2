    ...
    <div className={styles.header}>
      <div className={styles.headerContent}>
        <div className={styles.logo}>
          <Link href="/">
            <img
              src={getProperty(properties, 'logo_image_url') ?? `${appConfig.productionUrl}/img/grubstack-logo-dark.png`}
              alt=""
            />
          </Link>
        </div>
        ...
        <div className={styles.navLinks}>
          ...
          <Link href="/menus" className={cls(styles.iconLink, styles.menuLink)}>
